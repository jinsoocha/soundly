...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SearchView = __webpack_require__(230);

	var _SearchView2 = _interopRequireDefault(_SearchView);

	var _QueueView = __webpack_require__(231);

	var _QueueView2 = _interopRequireDefault(_QueueView);

	var _SignupView = __webpack_require__(232);
	...
	var routes = {
	  ...
	  childRoutes: [{ path: 'queue',
	    component: _QueueView2.default }, { path: 'search',
	    component: _SearchView2.default }, { path: 'signup',
	...
	_reactDom2.default.render(_react2.default.createElement(_reactRouter.Router, { history: createBrowserHistory(), routes: routes }), app);
	  ...
	  _createClass(SearchView, [{
	    ...
	    value: function render() {
	      return React.createElement(
	        ...
	        React.createElement('input', { type: 'text', name: 'searchInput', ref: 'searchInput', placeholder: 'Keyword', required: true })
	      );
	    }
	  }]);
...
/***/ function(module, exports) {
	...
	var QueueView = function (_React$Component) {
	  _inherits(QueueView, _React$Component);

	  function QueueView(props) {
	    _classCallCheck(this, QueueView);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(QueueView).call(this, props));

	    _this.state = {};
	    return _this;
	  }

	  _createClass(QueueView, [{
	    key: 'render',
	    value: function render() {
	      var _this2 = this;
	      ...
	      return React.createElement(
	        ...
	        React.createElement(
	          ...
	          queue.map(function (song, i) {
	            return React.createElement(QueueEntryView, {
	              key: song.id,
	              song: song,
	              index: i,
	              upVote: _this2.props.upVote,
	              downVote: _this2.props.downVote
	            });
	          })
	        )
	      );
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              "p",
	              null,
	              React.createElement("input", { type: "text", name: "usernameInput", ref: "userInput" }),
	              React.createElement("input", { type: "text", name: "passwordInput", ref: "userInput" })
	            )
	          )
	        )
	      );
